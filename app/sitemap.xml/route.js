...
export async function GET() {
  const baseUrl = 'https://esraaelbialy.site'; // Change to your actual domain
  ...
  try {
    ...
    const courseRes = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://esraaelbialy.site'}/course`);
